    ...
    <div class="body">
      ...
      <div class="follow-block">
        <div class="follow-item" @click.stop="goPath(`/user/${props.account.acct}?tab=tweets`)">
          <div class="item-count">{{ props.account.status_count }} {{ $t('public.tweet') }}</div>
        </div>
        <div class="follow-item" @click.stop="goUserSocial('following')">
          <div class="item-count">{{ props.account.following_count }} {{ $t('account.following') }}</div>
        </div>
        <div class="follow-item" @click.stop="goUserSocial('follower')">
          <div class="item-count">{{ props.account.followers_count }} {{ $t('account.follower') }}</div>
        </div>
      </div>
    </div>
  </div>
